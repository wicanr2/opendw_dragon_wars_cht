...
> 📋 完整狀態索引見 [99_INDEX.md](99_INDEX.md);全 docs 審查與待裁決見 [00_DOC_AUDIT.md](assessment/00_DOC_AUDIT.md)。
...
| 檔案 | 說明 |
|------|------|
| [01_PLAN.md](reverse-engineering/01_PLAN.md) | ✏️ 早期總體規劃（字型尺寸矛盾,以 07 為準） |
| [02_ANALYSIS.md](reverse-engineering/02_ANALYSIS.md) | ✅ 反組譯還原分析（ASM ↔ C 對應表） |
| [03_REVIEW_REPORT.md](reverse-engineering/03_REVIEW_REPORT.md) | ✏️ 專案審查報告（3,926 條成果結論已作廢） |
...
| 檔案 | 說明 |
|------|------|
| [10_TRANSLATION.md](translation/10_TRANSLATION.md) | ✏️ 主翻譯表(雜訊條目已刪、譯名已對齊) |
| [11_TRANSLATION_DIALOGUE.md](translation/11_TRANSLATION_DIALOGUE.md) | ✏️ 對話翻譯(Purgatory/Namtar/Humbaba 等已統一) |
| [12_TRANSLATION_ITEMS.md](translation/12_TRANSLATION_ITEMS.md) | ✏️ 物品翻譯(臆測物品已刪,僅留已驗證武器/防具) |
| [13_TRANSLATION_SKILLS.md](translation/13_TRANSLATION_SKILLS.md) | ✏️ 技能翻譯 |
| [14_TRANSLATION_MONSTERS.md](translation/14_TRANSLATION_MONSTERS.md) | ✏️ 怪物翻譯(改參考 26) |
...
| [21_DATA1_RESOURCE_INDEX.md](reverse-engineering/21_DATA1_RESOURCE_INDEX.md) | ✏️ DATA1 資源索引(文字數不可信) |
| [22_DATA1_SECTION_DETAILS.md](reverse-engineering/22_DATA1_SECTION_DETAILS.md) | ✏️ 區段分析(0x08–0x16 文字數為假象) |
| [23_SOURCE_CODE_MAP.md](reverse-engineering/23_SOURCE_CODE_MAP.md) | ✅ 原始碼地圖（22 個檔案） |
| [24_SCRIPT_TEXT_MAPPING.md](reverse-engineering/24_SCRIPT_TEXT_MAPPING.md) | ✏️ 腳本文字映射 |
...
| [32_EN_MANUAL_TEXT.md](manual/32_EN_MANUAL_TEXT.md) | ✅ 英文手冊 OCR（48 頁,粗糙待校） |
...
| [35_SOFTWORLD_25.md](walkthrough/35_SOFTWORLD_25.md) | ✅ 《軟體世界》25 期攻略 |
| [36_SOFTWORLD_26.md](walkthrough/36_SOFTWORLD_26.md) | ✅ 《軟體世界》26 期攻略 |
| [37_SOFTWORLD_27.md](walkthrough/37_SOFTWORLD_27.md) | ✅ 《軟體世界》27 期攻略 |

### 資產
| 檔案 | 說明 |
|------|------|
| [monster_sprites/](media/monster_sprites) | 怪物 sprite PNG（59 張，含總覽圖） |
| [scene_pictures/](walkthrough/scene_pictures) | 6 張全螢幕過場圖（片頭/結局，res 24–29） |

### 參考 / 建置 / 測試（40-60）
| 檔案 | 說明 |
|------|------|
| [40_ORIGINAL_DOCS_SUMMARY.md](reverse-engineering/40_ORIGINAL_DOCS_SUMMARY.md) | ✏️ 原始文件摘要(怪物 sprite 編號已加註) |
...
| [60_SKILL.md](assessment/60_SKILL.md) | Skill 文件（完整經驗記錄） |
...
| [珍066-火龍之戰.rar](manual/珍066-火龍之戰.rar) | 中文手冊（RAR4 壓縮） |
...
### 閱讀順序(現行)
1. **基準**：[00_DOC_AUDIT.md](assessment/00_DOC_AUDIT.md) → [../CONTEXT.md](../CONTEXT.md) → [07_REVISED_PLAN.md](engine/07_REVISED_PLAN.md)
2. **分析**：[02_ANALYSIS.md](reverse-engineering/02_ANALYSIS.md) → [25_OPCODE_INTERPRETATION.md](reverse-engineering/25_OPCODE_INTERPRETATION.md) / [OPCODE_REFERENCE.md](reverse-engineering/OPCODE_REFERENCE.md)
3. **文字/資料**：[ALL_TEXT_FROM_SCRIPTS.txt](reverse-engineering/ALL_TEXT_FROM_SCRIPTS.txt)(乾淨文字) → [26_MONSTERS_AND_SPRITES.md](reverse-engineering/26_MONSTERS_AND_SPRITES.md)
4. **翻譯**：[10_TRANSLATION.md](translation/10_TRANSLATION.md) → [11-14_*.md](translation/11_TRANSLATION_DIALOGUE.md)(讀前先看各檔頂部警語)
5. **手冊**：[33_MANUAL_TRANSCRIPTION.md](manual/33_MANUAL_TRANSCRIPTION.md) → [34_READ_PARAGRAPHS.md](manual/34_READ_PARAGRAPHS.md)
6. **實作**：[06_IMPLEMENTATION_PLAN.md](engine/06_IMPLEMENTATION_PLAN.md) → [05_SDL2_IMPLEMENTATION.md](engine/05_SDL2_IMPLEMENTATION.md) → [50_BUILD.md](engine/50_BUILD.md)
...
**關鍵結論**：先前「113 個未實作 opcode 是大工程」被高估。真正要處理的只有 ~22 個，其中與字串顯示直接相關的只有 4 個（`set_msg` 變體 0x79、角色名/格式化 0x7E/0x7F、`read_string` 變體 0x8F）。詳見 [25_OPCODE_INTERPRETATION.md](reverse-engineering/25_OPCODE_INTERPRETATION.md)（繁中）與 [OPCODE_REFERENCE.md](reverse-engineering/OPCODE_REFERENCE.md)（中英雙語對外版）。

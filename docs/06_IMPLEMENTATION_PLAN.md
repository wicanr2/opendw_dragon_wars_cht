...
> ℹ️ **註(2026-06-10)**:本檔引用 `03_REVIEW_REPORT.md` / `04_NEXT_PLAN.md` 的舊萃取數據(3,926 條),
> 該數據為雜訊(見 `07_REVISED_PLAN.md`)。CJK 顯示/渲染的**實作路徑**主體仍有效,
> 但凡涉及「待翻譯文字數量/萃取來源」一律以 `07_REVISED_PLAN.md` 為準。

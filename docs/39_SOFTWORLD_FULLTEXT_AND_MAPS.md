...
> - **39(本檔)**:**逐頁忠實存檔** —— 把每張掃描頁的文字**逐字解讀成可複製的 markdown**(文字歸文字)、把頁內**地圖切割成獨立圖檔**(地圖歸圖),並把每張地圖**重繪成乾淨的 SVG 向量圖**(原掃描切圖 + 重繪向量版**並列**),讓讀者能直接複製文字、單獨取用地圖、看到比低解析掃描更清楚的重繪。
>
> **出處**:《軟體世界》月刊 第 25 / 26 / 27 期(1991 年 4 / 5 / 6 月號),署名 /Lotus。版權屬《軟體世界》及原作者;本轉寫為非商業性歷史保存 / 中文化研究用途。完整版權聲明見 38 之 §1。
>
> **製作方式**:來源 PDF 以 300 DPI 重算(`pdftoppm -jpeg -r 300`,docker image `dwimg` = poppler + imagemagick + librsvg),由能讀圖的代理逐頁視覺判讀;地圖以 `imagemagick convert -crop` 切出獨立圖,存於 [`softworld_images/maps/`](softworld_images/maps);再逐張**重繪為 SVG 向量圖**(`rsvg-convert` 渲染回 PNG 與掃描圖比對驗證),存於 [`softworld_images/maps_svg/`](softworld_images/maps_svg),檔名與切割圖一一對應。
>
...
>
> **地圖重繪說明**:SVG 為**重繪示意**,目標是「乾淨、好讀、結構忠於掃描」,**非像素級復刻**。大型迷宮(如 Purgatory、Phoebus、Freeport)的密集細牆刻意簡化為主要通道與房間輪廓;編號點位置盡量對齊原圖。少數被掃描裁切或插畫遮擋的編號點依相對位置推補,不臆造牆體。瑪根地底世界(Magan Underworld)原圖為開闊區域,重繪為「節點 + 連線」的區域連接示意。
>
> 39 張切割地圖 + 39 張重繪 SVG 一覽見文末附錄。
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-035_purgatory.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-036_slave_camp.svg)![Slave Mines 礦場 方格地圖](softworld_images/maps/sw25-036_slave_mines.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-036_slave_mines.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-037_mog_estate.svg)![Tars Ruins 塔斯廢墟 方格地圖](softworld_images/maps/sw25-037_tars_ruins.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-037_tars_ruins.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-038_tars_dungeon.svg)![Guarded Bridge 橋梁 方格地圖](softworld_images/maps/sw25-038_guarded_bridge.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-038_guarded_bridge.svg)![Phoebus 菲巴斯 方格地圖](softworld_images/maps/sw25-038_phoebus.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-038_phoebus.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw25-039_phoebus_dungeon.svg)（註:本頁左欄為 Phoebus 城正文,地圖僅一張「Phoebus dungeon 菲巴斯地牢」;城本身的方格地圖在 p36)
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-036_mystic_wood.svg)![Heavily guarded bridge 橋樑](softworld_images/maps/sw26-036_guarded_bridge.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-036_guarded_bridge.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-037_lansk.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-038_war_bridge.svg)![Lansk Undercity 蘭斯克地下城](softworld_images/maps/sw26-038_lansk_undercity.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-038_lansk_undercity.svg)![Yellow Mud Toad 黃泥蟾蜍城](softworld_images/maps/sw26-038_yellow_mud_toad.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-038_yellow_mud_toad.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw26-039_lanactoor_lab.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-044_smugglers_cove.svg)![The Necropolis 奈羅波裡地圖](softworld_images/maps/sw27-044_necropolis.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-044_necropolis.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-045_magan_underworld.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-046_old_dock.svg)![Bridge of Exiles 放逐橋地圖](softworld_images/maps/sw27-046_bridge_of_exiles.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-046_bridge_of_exiles.svg)![Snakepit 蛇窟地圖](softworld_images/maps/sw27-046_snakepit.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-046_snakepit.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-047_dwarf_ruins.svg)![Dwarf Clanhall 矮人城堡地圖](softworld_images/maps/sw27-047_dwarf_clanhall.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-047_dwarf_clanhall.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-048_siege_camp.svg)![City of Byzanople 拜占儂市地圖](softworld_images/maps/sw27-048_byzanople.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-048_byzanople.svg)![Byzanople Dungeon 指揮部地圖](softworld_images/maps/sw27-048_byzanople_dungeon.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-048_byzanople_dungeon.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-049_kingshome.svg)![Kingshome Dungeon 京雄城地牢地圖](softworld_images/maps/sw27-049_kingshome_dungeon.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-049_kingshome_dungeon.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-050_freeport.svg)![Royal Game Preserve 皇家專有獵區](softworld_images/maps/sw27-050_royal_game_preserve.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-050_royal_game_preserve.svg)![Scorpion Bridge 蠍橋](softworld_images/maps/sw27-050_scorpion_bridge.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-050_scorpion_bridge.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-051_college_of_magic.svg)![Dragon Valley 龍谷](softworld_images/maps/sw27-051_dragon_valley.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-051_dragon_valley.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-052_sunken_ruins_above.svg)![Sunken Ruins (Below Water) 沉沒之城-水下](softworld_images/maps/sw27-052_sunken_ruins_below.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-052_sunken_ruins_below.svg)![Pilgrim Dock 朝聖者碼頭](softworld_images/maps/sw27-052_pilgrim_dock.jpg)
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-052_pilgrim_dock.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-053_nisir.svg)
**全文轉寫**
...
![↑ 同圖重繪向量版（SVG）](softworld_images/maps_svg/sw27-054_depth_of_nisir.svg)
**全文轉寫**
...
## 附錄:39 張切割地圖 + 39 張重繪 SVG 一覽

> 切割掃描圖位於 [`softworld_images/maps/`](softworld_images/maps),檔名格式 `<掃描頁>_<地點slug>.jpg`;
> 每張另有**同名重繪向量圖** `.svg`,位於 [`softworld_images/maps_svg/`](softworld_images/maps_svg)(例 `sw25-035_purgatory.jpg` ↔ `sw25-035_purgatory.svg`)。
